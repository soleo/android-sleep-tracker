...
By using our analysis method, all 8 audio samples with 78 snoring episodes are detected in MatLab. However, playing the samples in laptop output,  the amount of detected snoring sound is significantly less. \\
